            ...
            <div className="w-full max-w-md bg-white dark:bg-stone-900 p-8 my-4 rounded-2xl border border-stone-200 dark:border-stone-800 shadow-xl transition-all duration-300">
                ...
                <form className="space-y-4" onSubmit={handleSubmit}>
                    ...
                    <button
                        type="submit"
                        disabled={isLoading}
                        className={`w-full flex items-center justify-center gap-2 py-3 px-4 mt-4 rounded-xl text-white font-medium bg-lime-500 hover:bg-lime-700 hover:text-white dark:text-stone-950 hover:scale-[1.01] transition-all duration-300 ease-out ${isLoading ? 'opacity-70 cursor-not-allowed' : 'cursor-pointer shadow-md'
                            }`}
                    >
                        {isLoading ? (
                            <>
