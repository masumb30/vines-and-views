...
export default function CreatePostPage() {
  ...
  const handleGenerateAIPost = async () => {
    ...
    try {
      const response = await fetch("${process.env.NEXT_PUBLIC_API_URL}/posts/generate-ai", {
        method: "POST",
        headers: {
